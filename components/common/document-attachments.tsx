            ...
            <div key={a.id} className="rounded border p-2">
              {a.mimeType.startsWith('image/') && (
                <img
                  ...
                  alt={a.fileName}
                  className="mb-2 h-40 w-full rounded object-cover border"
                />
              )}
              {a.mimeType.startsWith('video/') && (
                <video
                  controls
                  className="mb-2 h-48 w-full rounded border bg-black"
                  src={normalizePublicUrl(a.url)}
                />
              )}
              <div className="flex items-center justify-between">
                ...
                <div className="text-xs text-gray-500">{a.mimeType} • {formatBytes(a.fileSize)}</div>
              </div>
              <div className="flex items-center gap-1">
                ...
                <Button type="button" variant="ghost" size="sm" onClick={() => deleteAttachment(a.id)}>
