...
export async function GET(
  ...
  try {
    ...
    function buildRow(li: (typeof mainItems)[0]) {
      if (li.isSubtotal) {
    ...
    <div class="page">
      <div class="header">
        <div>
          <div class="brand">
            ${logoUrl
              ? `<img class="logo-image" src="${escapeHtml(String(logoUrl))}" alt="Logo" />`
    ...
    try {
      ...
      return new NextResponse(pdf, {
        ...
        headers: {
          ...
          'Content-Disposition': `attachment; filename="Estimate-${escapeHtml(estimate.estimateNumber)}.pdf"`,
        },
      })
    } catch (e) {
