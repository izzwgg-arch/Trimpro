    ...
    subPages: [
      {
        ...
        description: 'Reports → Payment History page and payment list API',
        permissionKey: 'payments.view',
      },
    ],
    extraActionKeys: ['payments.manage', 'payments.refund'],
  },
  {
    id: 'dispatch',
    label: 'Dispatch',
...
export function isModulePageAccessEnabled(
  ...
  return selectedPermissions.includes(module.pageAccessPermission)
}
