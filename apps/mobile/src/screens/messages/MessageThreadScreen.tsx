    ...
    <SafeAreaView style={styles.screen} edges={['top', 'left', 'right']}>
      <View style={styles.content}>
        ...
        <FlatList
          ...
          contentContainerStyle={[styles.listContent, { paddingBottom: inputBarHeight }]}
        ...
        {/* Single keyboard strategy: KAV with top offset = status bar + header so dock sits above keyboard when open and flush to tab bar when closed. */}
        <KeyboardAvoidingView
