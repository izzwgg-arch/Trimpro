    ...
    <SafeAreaView style={styles.screen} edges={['top', 'left', 'right']}>
      ...
      >
        <View style={styles.header}>
          <View style={{backgroundColor:'#FF0000',paddingHorizontal:8,paddingVertical:2,borderRadius:4,position:'absolute',top:2,right:8,zIndex:999}}><Text style={{color:'#fff',fontSize:10,fontWeight:'900'}}>PLUTO TEST MARKER A</Text></View>
